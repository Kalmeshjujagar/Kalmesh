...
export default function SignIn() {
  ...
  return (
    <div className=" mt-10 max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      <h2 className="mx-10 font-bold text-xl text-neutral-700 dark:text-neutral-300">
        Welcome to Godihal : )
      </h2>

      <form className="my-8 mx-6" onSubmit={handleSubmit}>
        <LabelInputContainer className="mb-4">
          <Label htmlFor="email">Email Address</Label>
          <Input
            id="email"
            placeholder="sachinpatil21@gmail.com"
            type="email"
          />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
